...
| A24 | Render de puertas globales (divididas o completas) | Guardian | ✅ Completado | `isometricRenderer.js` reparte ancho según `izq`/`der`; una sola ocupa todo. 116 tests OK. |
