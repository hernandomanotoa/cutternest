...
const CONFIG_FIELDS = [
  ...
  { key: 'drawerFaceGap', label: 'Gap entre frentes de cajón (mm)' },
  { key: 'drawerBottomOffset', label: 'Altura base frentes de cajón (mm)' },
  { key: 'doorGap', label: 'Gap entre puertas (mm)' },
  { key: 'doorTopOffset', label: 'Margen superior puertas (mm)' },
  { key: 'doorBottomOffset', label: 'Margen inferior puertas (mm)' },
  { key: 'braceTopOffset', label: 'Offset travesaño superior (mm)' },
  { key: 'braceBottomOffset', label: 'Offset travesaño inferior (mm)' },
  { key: 'mirrorOffset', label: 'Offset espejo desde tapa (mm)' },
  { key: 'legOffsetX', label: 'Margen patas desde lateral (mm)' },
